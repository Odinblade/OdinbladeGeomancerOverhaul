...
vertex VertexOutput Materials_OdinGEO_Summon_EarthElemental_ST_DEF_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
static void CalculateMatNormal(float2 in_0,
	...
	texture2d<float> Texture2DParameter_485a3ae2daf645658bfcfad17db47ab6_DefaultWrapSampler)
{
...
static void CalculateMatBaseColor(float2 in_0,
	thread float3& out_0,
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_170180fa515740abada70b5f5821c414_DefaultWrapSampler)
{
...
static void CalculateMatReflectance(float2 in_0,
	thread float& out_0,
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_b8d642c0d4214b4ca58b298bed225d6e_DefaultWrapSampler)
{
...
fragment PixelOutput Materials_OdinGEO_Summon_EarthElemental_ST_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
	...
	texture2d<float> Texture2DParameter_b8d642c0d4214b4ca58b298bed225d6e_DefaultWrapSampler)
{
	...
	float3 matNormal;
	CalculateMatNormal(In.TexCoords0, matNormal, _DefaultWrapSampler, Texture2DParameter_485a3ae2daf645658bfcfad17db47ab6_DefaultWrapSampler);
	//Normalize World Normal
	...
	float3 matBaseColor;
	CalculateMatBaseColor(In.TexCoords0, matBaseColor, _DefaultWrapSampler, Texture2DParameter_170180fa515740abada70b5f5821c414_DefaultWrapSampler);
	float matReflectance;
	CalculateMatReflectance(In.TexCoords0, matReflectance, _DefaultWrapSampler, Texture2DParameter_b8d642c0d4214b4ca58b298bed225d6e_DefaultWrapSampler);
