...
vertex VertexOutput Materials_OdinGEO_Summon_EarthElemental_STI_SHA_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput Materials_OdinGEO_Summon_EarthElemental_STI_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
